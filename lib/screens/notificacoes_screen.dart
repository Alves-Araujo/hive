...
// sininho com a contagem de nao lidas -- usado no cabecalho do Resumo
class BotaoNotificacoes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<int>(
      ...
      builder: (context, naoLidas, _) {
        return Semantics(
          button: true,
          label: naoLidas > 0 ? 'Notificações, $naoLidas não lidas' : 'Notificações',
            ...
            child: Stack(
              ...
              children: [
                Container(
                  ...
                  child: Icon(
                    naoLidas > 0 ? Icons.notifications_rounded : Icons.notifications_none_rounded,
                    color: isDark ? Colors.white : const Color(0xFF14304F),
                    size: 22,
                  ),
                ),
                if (naoLidas > 0)
