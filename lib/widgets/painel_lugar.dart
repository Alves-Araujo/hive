...
class PainelLugar extends StatelessWidget {
  ...
  Future<void> _abrirNoGoogleMaps(BuildContext context) async {
    ...
    final url = lugar.linkGoogleMaps ??
    ...
    if (!ok) {
      messenger.showSnackBar(
        const SnackBar(content: Text('Não foi possível abrir o Google Maps.'), backgroundColor: corErro),
      );
    }
  }
            ...
            Padding(
              ...
              child: lugar.fotos.isEmpty
                  ? Container(
                      ...
                      child: Icon(lugar.categoria.icone, color: Colors.white38, size: 44),
                    )
                  : GaleriaFotos(
                      fotos: [
                        for (final f in lugar.fotos) FotoInatel(f.url(), credito: 'Foto: ${f.autor}'),
                      ],
                      isDark: isDark,
                ...
                children: [
                  Row(
                    children: [
                      Container(
                        ...
                        child: Icon(lugar.categoria.icone, color: Colors.white, size: 22),
                      ),
                  ...
                  if (lugar.endereco.isNotEmpty) ...[
                    ...
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Icon(Icons.place_rounded, size: 18, color: isDark ? Colors.white38 : Colors.black38),
